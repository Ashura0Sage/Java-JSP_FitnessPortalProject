...
public class PostLikeWorker {
     public static String addPostLike(PostLike pLike)
   {
       ...
       try
       {
          ...
          pstmt.setString(2,pLike.getPostId());
   ...
   public static String updatePostLike(PostLike pLike)
   {
       ...
       try
       {
          ...
          String query = "Update PostLike set PostId=?, UserId=?, Status=?, Time=? where Id=?;" ;
           ...
           pstmt.setString(1,pLike.getPostId());
       ...
       try
       {
           ...
           while(rs.next())
           {
               pLike = new PostLike();
                ...
                pLike.setPostId(rs.getString("PostId"));
   ...
   public static String likeStatusCheck(String postId,String userId)
   {
	   String status = "";
       try
       {
   ...
   public static void postLike(String postId, String userId)
   {
   ...
   public static void postUnlike(String postId, String userId)
   {
       String result = "";
       try
       {
