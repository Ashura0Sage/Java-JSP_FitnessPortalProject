...
public class CardWorker {
   ...
   public static ArrayList<Card> getAllCardsById(String id)
   {
   ...
   public static String verifyCvv(String id, String cvv) 
   {
