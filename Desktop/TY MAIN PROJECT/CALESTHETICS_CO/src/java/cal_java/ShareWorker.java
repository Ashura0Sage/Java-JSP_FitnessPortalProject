...
public class ShareWorker {
     public static String addShare(Share pShare)
   {
       ...
       try
       {
          ...
          pstmt.setString(2,pShare.getPostId());
   ...
   public static String updateShare(Share pShare)
   {
       ...
       try
       {
          ...
          String query = "Update Share set PostId=?, UserId=?, Status=?, Time=? where Id=?;" ;
           ...
           pstmt.setString(1,pShare.getPostId());
       ...
       try
       {
           ...
           while(rs.next())
           {
               pShare = new Share();
                ...
                pShare.setPostId(rs.getString("PostId"));
   ...
   public static String shareStatusCheck(String postId,String userId)
   {
	   String status = "";
       try
       {
   ...
   public static void postShare(String postId, String userId)
   {
   ...
   public static void postUnshare(String postId, String userId)
   {
       String result = "";
       try
       {
