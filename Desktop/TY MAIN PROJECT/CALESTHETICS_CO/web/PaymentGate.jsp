<%@ page import="cal_java.*, java.util.*;" language="java"
...
<script language="javascript">
	...
	$(document).ready(function() {
		...
		$("button[btn-pay]").click(function(e){
			e.preventDefault();
			var id = $(this).val();
		...
		$("button[btn-proceed-pay]").click(function(e){
			e.preventDefault();
			var id = $(this).val();
			var amount = $("#amount").val();
			var cvv = $("[cvv='"+id+"']").val();
 ...
 <body style="background-color: lightgrey">
	...
	<div class="media well">
		...
		<div class="media-left" style="width:30%;">
				<h3>Enter the Price to be paid </h3>
		...
		<div class="media-right" style="width:15%;">
			...
			<div class="media-right media-middle">
                            <input type="number" min="1" id="amount" value="<%= price%>" disabled>
			</div>
			</div>
	...
	<%
      ArrayList<Card> list = CardWorker.getAllCardsById(id);
   	if(!list.isEmpty())
   	{
   		for(Card card:list)
   		{
		...
		<div class="panel panel-card well">
				...
				<div class="panel-heading">
					<div class="media">
						...
						<button btn-pay value="<%=card.getId()%>">
						<i class="fa fa-inr fa-2x"></i><span>&nbsp;&nbsp;</span><span class="h4">Pay</span>
						</button>
							<div pay-modal="<%=card.getId()%>" class="modal fade">
								<div class="modal-dialog modal-md">
									<div class="modal-content">
										...
										<div class="media">
											<div class="media-body">
											<h3>Order the selected program?</h3>
											</div>
											<div class="media-right media-middle">
										...
										<div class="modal-footer">
											<button btn-yes value="<%=card.getId()%>"class="btn btn-primary" data-dismiss="modal">Yes, Pay</button>
							...
							<div cvv-pin-modal="<%=card.getId()%>" class="modal fade">
								<div class="modal-dialog modal-md">
									<div class="modal-content">
										...
										<div class="modal-footer">
											<button btn-proceed-pay value="<%=card.getId()%>"class="btn btn-primary" data-dismiss="modal">Proceed</button>
